...
router.get('/authorize/spotify', async (req, res) => {
    ...
    console.log(auth.data, userInfo.data)
...
router.get('/api/user/:username', async (req, res) => {
    ...
    res.send({ username: req.session.username, displayname: user.display_name, isCurrentUser })
})
...
/* FETCH ROUTES */
router.get('/api/fetch/song/:songId', async (req, res) => {
